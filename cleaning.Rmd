...
# Create r1_id for filtering data_rent and data_social
...
st_write(inspire_grid_berlin, "./daten/inspire_grid_berlin.gpkg")
...
data_social <- data_social_complete %>%
  ...
  mutate(anzahl_haushalte = r1_mba_a_haushalt,

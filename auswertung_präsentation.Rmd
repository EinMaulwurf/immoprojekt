...
data_LQ_sf <- data_social_sf %>%
  ...
  mutate(LQ_arbeitslose = arbeitslosenquote / weighted.mean(arbeitslosenquote, anzahl_haushalte, na.rm = TRUE),
         ...
         .keep = c("unused")) %>%
  ungroup() %>%
  filter(!is.na(LQ_arbeitslose), !is.na(LQ_auslaender)) %>%
  filter(jahr %in% c(2010, 2019))
```
...
data_LQ_sf %>%
  ...
  labs(subtitle = "LQ Arbeitslose", fill = NULL) +
  theme_bw() +
...
#ggsave("./plots_präsentation/lq_arbeitslosenquote_2010_2019_pascal.jpg")
```
...
data_LQ_sf %>%
  ...
  facet_wrap(~jahr)+
  scale_fill_manual(values = c("blue", "green", "white", "orange", "red")) +
  labs(subtitle = "LQ Ausländer", fill = NULL) +
  theme_bw() +
  theme(legend.position = "top",
        axis.text = element_blank(),
        axis.ticks = element_blank(),
...
#ggsave("./plots_präsentation/lq_auslaender_2010_2019_pascal.jpg")
```
...
#ggsave("./plots_präsentation/plot_cluster_jahr_vergleich.png", plot = plot_arranged)
```
...
## Tabelle, Karte & Plot: Regression Brennpunkte
Plot Brennpunkte
...
#ggsave("./plots_präsentation/plot_brennpunkte.png")
```
...
#ggsave("./plots_präsentation/plot_regression_brennpunkte_modell.png")
```
...
expand.grid(jahr = (2007:2020) - 2007,
  ...
  theme(legend.position = c(0.1, 0.75),
        legend.background = element_blank())+
  labs(x = "Jahr", y = element_blank(), color = "")

#ggsave("./plots_präsentation/plot_regression_cluster_modell.png")
```
